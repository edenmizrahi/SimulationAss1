...
mean_generator50= weibullDistributionParams(generatorList50, 1.2)
print('50 numbers')
print('Estimation:')
print(f"Mean:  {mean_generator50}")
#200
generatorList200 = weibullDistribution(random200, 1.2, 76000, 0)
mean_generator200= weibullDistributionParams(generatorList200, 1.2)
print('200 numbers')
print('Estimation:')
print(f"Mean:  {mean_generator200}")
#500
generatorList500 = weibullDistribution(random500, 1.2, 76000, 0)
mean_generator500= weibullDistributionParams(generatorList500, 1.2)
print('500 numbers')
print('Estimation:')
...
mean_lubrication50= weibullDistributionParams(lubricationList50, 1.3)
print('50 numbers')
print('Estimation:')
print(f"Mean:  {mean_lubrication50}")
#200
lubricationList200 = weibullDistribution(random200, 1.3, 66000, 0)
mean_lubrication200= weibullDistributionParams(lubricationList200, 1.3)
print('200 numbers')
print('Estimation:')
print(f"Mean:  {mean_lubrication200}")
#500
lubricationList500 = weibullDistribution(random500, 1.3, 66000, 0)
mean_lubrication500= weibullDistributionParams(lubricationList500, 1.3)
print('500 numbers')
print('Estimation:')
...
mean_electrical50= weibullDistributionParams(electricalList50, 1.5)
print('50 numbers')
print('Estimation:')
print(f"Mean:  {mean_electrical50}")
#200
electricalList200 = weibullDistribution(random200, 1.5, 35000, 0)
mean_electrical200= weibullDistributionParams(electricalList200, 1.5)
print('200 numbers')
print('Estimation:')
print(f"Mean:  {mean_electrical200}")
#500
electricalList500 = weibullDistribution(random500, 1.5, 35000, 0)
mean_electrical500= weibullDistributionParams(electricalList500, 1.5)
print('500 numbers')
print('Estimation:')
